-- Migration 012: cmrc_sync_versions — tracks per-entity sync version for conflict detection
...
CREATE TABLE IF NOT EXISTS cmrc_sync_versions (
...
CREATE INDEX IF NOT EXISTS idx_sync_versions_tenant
  ON cmrc_sync_versions (tenant_id, entity_type);
