 ...
 *   /api/commerce/subscriptions      — Subscription products (Paystack recurring)
 ...
 *   /api/commerce/purchase-orders    — PO generator
...
commerceRouter.route('/subscriptions', subscriptionsRouter);
...
commerceRouter.route('/purchase-orders', purchaseOrdersRouter);
...
commerceRouter.get('/health', (c) =>
  c.json({
    ...
    data: {
      ...
      version: '4.2.0',
      sub_modules: [
        'abandoned-carts', 'subscriptions', 'gift-cards', 'flash-sales',
        'bundles', 'purchase-orders', 'commissions', 'segmentation',
